...
import 'package:market_infinite/common/widgets/stars.dart';
import 'package:market_infinite/features/product_details/services/product_details_services.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.all(8),child: RichText(text: TextSpan(text: "Deal Price: ",style: const TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold,),
            children: [
            ...
            RatingBar.builder(
              ...
              itemBuilder: (context,_) => const Icon(Icons.star,color: GlobalVariables.secondaryColor,), onRatingUpdate: (rating) {
